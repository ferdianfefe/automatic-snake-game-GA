...
class Game:
    ...
    def __init__(self, size, num_snakes, players, gui=None, display=False, max_turns=100):
        ...
        self.food_index = 0
        self.food_xy = [(2, 4), (8, 2), (9, 3), (9, 3), (7, 3), (6, 2), (7, 1), (6, 1), (3, 0), (9, 0), (4, 2), (0, 1), (8, 8), (5, 7), (9, 3), (0, 2), (5, 1), (7, 1), (8, 6), (4, 1), (7, 3), (4, 5), (1, 9), (6, 3), (4, 7), (6, 5), (1, 0), (2, 8), (5, 1), (1, 7), (6, 0), (9, 0), (7, 9), (7, 6), (9, 8), (5, 5), (0, 8), (2, 0), (3, 1), (7, 4), (2, 0), (2, 8), (2, 3), (9, 1), (7, 4), (2, 9), (1, 4), (7, 0), (1, 8), (6, 9), (4, 9), (2, 3), (0, 7), (1, 3), (2, 2), (0, 6), (9, 9), (2, 8), (7, 9), (7, 3), (0, 6), (1, 4), (6, 7), (1, 5), (8, 9), (2, 9), (1, 8), (3, 7), (2, 2), (7, 2), (2, 6), (3, 1), (2, 9), (0, 3), (2, 0), (5, 7), (7, 4), (5, 0), (4, 3), (1, 2), (5, 4), (3, 4), (7, 3), (3, 3), (4, 7), (9, 3), (4, 1), (0, 7), (3, 1), (7, 6), (6, 1), (5, 1), (1, 7), (2, 5), (4, 2), (9, 3), (4, 7), (4, 5), (7, 9), (7, 3), (0, 3), (1, 8), (2, 9), (7, 8), (7, 9), (3, 8), (6, 3), (3, 5), (4, 1), (1, 3), (1, 5), (4, 1), (5, 7), (3, 4), (3, 5), (9, 4), (7, 5), (3, 3), (5, 3), (1, 0), (5, 3), (4, 1), (8, 1), (5, 5), (4, 4), (7, 6), (5, 4), (3, 9), (7, 2), (0, 4), (7, 1), (7, 6), (5, 6), (4, 7), (8, 0), (0, 9), (5, 7), (3, 7), (1, 7), (6, 0), (6, 7), (3, 1), (1, 9), (0, 8), (1, 3), (8, 2), (8, 8), (0, 3), (3, 9), (9, 6), (5, 1), (2, 8), (9, 9), (5, 0), (0, 0), (2, 2), (8, 4), (1, 3), (7, 9), (9, 4), (3, 6), (2, 4), (7, 0), (0, 0), (6, 8), (7, 7), (8, 9), (5, 4), (7, 1), (4, 5), (2, 2), (0, 3), (7, 6), (9, 2), (9, 6), (9, 6), (1, 2), (5, 1), (2, 3), (2, 1), (8, 0), (0, 9), (5, 7), (7, 6), (6, 8), (3, 3), (0, 8), (3, 9), (2, 6), (7, 6), (2, 6), (0, 5), (5, 4), (2, 4), (5, 2), (8, 1), (7, 7), (7, 2), (8, 5), (9, 0)]
...
class Gui:
    ...
    def __init__(self, game,size):
        ...
        for i in range(len(self.game.snakes)):
            ...
            self.canvas.create_rectangle(snake[-1][1] * self.ratio, snake[-1][0] * self.ratio, (snake[-1][1] + 1) * self.ratio, (snake[-1][0] + 1) * self.ratio, fill=color)

            for j in range(len(snake) - 1):
                color = '#' + '{0:03X}'.format((i + 1)*123)
                self.canvas.create_rectangle(snake[j][1] * self.ratio, snake[j][0] * self.ratio, (snake[j][1] + 1) * self.ratio, (snake[j][0] + 1) * self.ratio, fill=color)

        for food in self.game.food:
            self.canvas.create_rectangle(food[1] * self.ratio, food[0] * self.ratio, (food[1] + 1) * self.ratio, (food[0] + 1) * self.ratio, fill='#000000000')
